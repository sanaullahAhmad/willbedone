    ...
    <div class="row" id="approvedflag">
        ...
        if ($productsopflag == 'true') {
            ...
            <div class="col-md-12" id="section1">
                ...
                <table width="100%" border="1" class="processing-table">
                    <tbody><tr>
                        ...
                        <tr>
                            <td colspan="3"><p class="col-md-12">Date of preparation: <input type="text" class="mrg-hidden border-hidden datetimepicker4" name="fm1_date_of_prep" value="<?php Products::getValue('fm1_date_of_prep', $sopdata) ?>"></p></td>
                            <td colspan="3"><p class="col-md-12">Expiration date: <input type="text" class="mrg-hidden border-hidden datetimepicker4" name="fm1_date_of_exp" value="<?php Products::getValue('fm1_date_of_exp', $sopdata) ?>"></p></td>
                        </tr>
                        <tr>
                            <td colspan="3"><p class="col-md-12">Product #: <input type="text" class="mrg-hidden border-hidden" name="prduct_MSCID" value="<?php echo $product->MSCID; ?>"></p></td>
                            <td rowspan="2" colspan="3"><p class="col-md-12">Volume prepared:<input type="text" class="mrg-hidden border-hidden" name="fm1_vol_prep" value="<?php Products::getValue('fm1_vol_prep', $sopdata) ?>"></p></td>
                        </tr>
                        <tr>
                            <td colspan="3"><p class="col-md-12">Prepared by:<input type="text" class="mrg-hidden border-hidden" name="fm1_prep_by" value="<?php Products::getValue('fm1_prep_by', $sopdata) ?>"></p></td>
                        </tr>
            ...
            if (Yii::$app->user->can('reviewer') || $approvedflag == 'true') {
                ...
                <div class="row">
                    <textarea rows="6" name="50034_s1_comments" class="form-control rcom"><?php Products::getValue('50034_s1_comments', $sopdata) ?></textarea>
                </div>
                <?php
            }
            ?>
            ...
            if ($productsopflag == 'true') {
                ...
                <div class="col-md-12" id="section2">
                    ...
                    <table width="100%" border="1" class="processing-table">
                        <tbody><tr>
                            ...
                            <tr>
                                <td colspan="3"><p class="col-md-12">Date of preparation:<input type="text" class="mrg-hidden border-hidden datetimepicker4" name="fm2_date_of_prep" value="<?php Products::getValue('fm2_date_of_prep', $sopdata) ?>"></p></td>
                                <td colspan="3"><p class="col-md-12">Expiration date:<input type="text" class="mrg-hidden border-hidden datetimepicker4" name="fm2_date_of_exp" value="<?php Products::getValue('fm2_date_of_exp', $sopdata) ?>"></p></td>
                            </tr>
                            <tr>
                                <td colspan="3"><p class="col-md-12">Product #:<input type="text" class="mrg-hidden border-hidden" name="product_id" value="<?php echo $product->MSCID; ?>"></p></td>
                                <td rowspan="2" colspan="3"><p class="col-md-12">Volume prepared:<input type="text" class="mrg-hidden border-hidden" name="fm2_vol_prep" value="<?php Products::getValue('fm2_vol_prep', $sopdata) ?>"></p></td>
                            </tr>
                            <tr>
                                <td colspan="3"><p class="col-md-12">Prepared by:<input type="text" class="mrg-hidden border-hidden" name="fm2_prep_by" value="<?php Products::getValue('fm2_prep_by', $sopdata) ?>"></p></td>
                            </tr>
                            <tr class="processing-table-background">
                                <th><h4 class="mailn-processing-hadding">Reagents</h4></th>
                                <th w=""><h4 class="mailn-processing-hadding">Manufacturer</h4></th>
                            ...
                            <tr>
                                ...
                                <td><div class="col-md-12">
                                        <input type="text" class="detail-content-form border-hidden" name="fm2_hespan_lotno" value="<?php Products::getValue('fm2_hespan_lotno', $sopdata) ?>">
                                    </div></td>
                                <td><div class="col-md-12 text-center">
                            ...
                            <tr>
                                <td colspan="5"><p class="col-md-12">Comments:</p></td>
                                <td><div class="col-md-12">
                                        <textarea class="detail-content-form border-hidden rcom" name="fm2_comments"><?php Products::getValue('pc_comments', $sopdata) ?></textarea>
                                    </div></td>
                            </tr>
                        </tbody></table>
                </div>
                ...
                if (Yii::$app->user->can('reviewer') || $approvedflag == 'true') {
                    ...
                    <div class="row">
                        <textarea rows="6" name="50034_s2_comments" class="form-control rcom"><?php Products::getValue('50034_s2_comments', $sopdata) ?></textarea>
                    </div>
                    <?php
                }
                ?>
                    ...
                    <div class="col-md-6">
                        <div class="input-group btn-group-lg">
                            ...
                            <label class="btn col-md">
                                <input type="text" class="mrg-hidden " name="50034_review_by" value="<?php Products::getValue('50034_review_by', $sopdata) ?>" id="reviewed_by">
                            </label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-group btn-group-lg">
                            ...
                            <label class="btn col-md">
                                <input type="text" class=" mrg-hidden datetimepicker4" name="50034_date" value="<?php Products::getValue('50034_date', $sopdata) ?>">
                            </label>
                        </div>
                    </div>
                    <?php
