...
if ($approvedflag == 'true') {
    ...
    <div class="row" id="approvedflag">
        ...
        <h2 class="text-center text-primary">Attachment Iv: Media Preparation Form: Complete Media with Antibiotics</h2>
        <br>
        <?php
        if ($productsopflag == 'true') {
            ...
            <div id="section1" class="col-md-12">
                ...
                <table width="100%" border="1" class="processing-table">
                    <tbody><tr>
                            <th width="18%" style="background:#666; color:#fff; padding-bottom: 22px;" colspan="8"><h4 class="mailn-processing-hadding">COMPLETE MEDIA WITHOUT ANTIBIOTICS</h4></th>
                        </tr>
                        <tr>
            ...
            if (Yii::$app->user->can('reviewer')) {
                ...
                <div class="col-md-6">
                    <div class="input-group btn-group-lg">
                        ...
                        <label class="btn col-md">
                            <input type="text" class="mrg-hidden" name="50004_review_by" value="<?php Products::getValue('50004_review_by', $sopdata) ?>" id="reviewed_by">
                        </label>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="input-group btn-group-lg">
                        ...
                        <label class="btn col-md">
                            <input type="text" class=" mrg-hidden datetimepicker4" name="50004_date" value="<?php Products::getValue('50004_date', $sopdata) ?>">
                        </label>
                    </div>
        ...
        if (Yii::$app->user->can('reviewer') || $approvedflag == 'true') {
            ...
            <div class="row">
                <textarea rows="6" name="50004_comments" class="form-control rcom"><?php Products::getValue('50004_comments', $sopdata) ?></textarea>
            </div>
            <?php
        }
        ?>
